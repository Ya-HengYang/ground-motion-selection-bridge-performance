...
source build.RCSection.Circ3D.tcl; # or source build.HollowSection3D.tcl;
   ...
   #ã€€For 4-span bridge, we may need to play with the integration scheme for convergence issue
   # e.g., 
   ...
   BuildRCcircSection $P2_ColTag $IDconcCore $IDconcCover $IDSteel $P2_Dsec $P2_cover $P2_barNum $P2_barArea $PierSecTagTorsion2 $P2SecTag3D 8 8 2 4   
   BuildRCcircSection $P3_ColTag $IDconcCore $IDconcCover $IDSteel $P3_Dsec $P3_cover $P3_barNum $P3_barArea $PierSecTagTorsion3 $P3SecTag3D 8 8 2 4   
   BuildRCcircSection $P4_ColTag $IDconcCore $IDconcCover $IDSteel $P4_Dsec $P4_cover $P4_barNum $P4_barArea $PierSecTagTorsion4 $P4SecTag3D 8 8 2 4  

   set Lpj 0.0;                # or  set Lpj [expr 5.0*$in];
   set Lpi [expr 41.20*$in];   # (Priestly & Park, 1987) *Used max for all 3 piers or set Lpj [expr $Lpi];   # old value 42.33 
   ...
   section Elastic $secTagInterior $Ec $Ap [expr 0.55*$Ipz] [expr 0.55*$Ipy] $Gc $Jpier 
   element forceBeamColumn $col2 2 102 $PierTransfTag "HingeMidpoint $P2_ColTag $Lpi $P2_ColTag $Lpj $secTagInterior"
   element forceBeamColumn $col3 3 103 $PierTransfTag "HingeMidpoint $P3_ColTag $Lpi $P3_ColTag $Lpj $secTagInterior"
