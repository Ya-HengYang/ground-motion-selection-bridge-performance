...
# confined concrete
set Kfc 1.30;                           # ratio of confined to unconfined concrete strength, SDC Eq. 3.3.6-4
...
set eps2C  [expr -0.0233];              # strain at ultimate stress *
...
set R0 10;                      # control the transition from elastic to plastic branches, original= 18
