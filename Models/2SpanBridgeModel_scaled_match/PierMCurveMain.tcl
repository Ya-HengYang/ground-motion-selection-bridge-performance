...
proc MomentCurvature {secTag axialLoad maxK {numIncr 100} } {
    ...
    recorder Element -file SteelFiber.out -time -ele 1 section fiber  -31 0.0  3 stressStrain
...
set barAreaSec [expr 1.56*$in*$in]
...
# SET AXIAL LOAD  
# ======================================================================
set P [expr -1296*$kip];    # + Tension, - Compression
